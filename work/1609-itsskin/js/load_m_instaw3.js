  ...
  if (page == 1) $(".insta-list-wrap").empty();
	...
	//	var q = "벨큐브";
		...
		$.ajax({
			...
			data: "q="+encodeURIComponent(q)+"&page="+page+"&setpage=4",
				...
				if(data[i].src =="E")
					...
					//alert(d);
						...
						idate = date3.toLocaleString(); // "Dec 20"uphoto
						  ...
						  var ncode = '<li><img class="insta-list-photo" src="'+data[i].src+'" alt="사진">';
						 ...
						 ncode = ncode +'<p class="detail-date">'+idate+'</p></div></li>';
