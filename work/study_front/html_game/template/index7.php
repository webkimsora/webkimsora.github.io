                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card-box">
                                ...
                                <iframe src="../HTMLGAME_YABAWI/index.html" id="htmlGameFrame" style="width: 100%; height: 700px; background: #fff; border: none;"></iframe>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card-box">
                            ...
                            <div class="card-box">
                                ...
                                <div class="text-left m-t-30">
                                    ...
                                    <a href="../HTMLGAME_YABAWI/HTMLGAME_YABAWI.zip" target="_blank" class="btn btn-block btn-info btn-custom waves-effect w-md waves-light m-b-5">DOWNLOAD</a>
                                </div>
                            </div>
                        </div>
                    </div>
