var heyIcon=(function($){return{init:function(){var alert=$('<div class="hey-icon">'+
...
'</div>'+
'</div>');$('body').append(alert);alert.on('click',function(){alert.fadeOut(150);});}}})(jQuery);$(function(){heyIcon.init();});